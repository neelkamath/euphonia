...
public class Artist_ {
    ...
    @Expose
    private List<ArtistNameTranslationList_> artistNameTranslationList = null;
    ...
    @Expose
    private List<ArtistAliasList_> artistAliasList = null;
    ...
    @Expose
    private ArtistCredits_ artistCredits;
    ...
    public List<ArtistNameTranslationList_> getArtistNameTranslationList() {
        return artistNameTranslationList;
    }

    public void setArtistNameTranslationList(List<ArtistNameTranslationList_> artistNameTranslationList) {
    ...
    public List<ArtistAliasList_> getArtistAliasList() {
        return artistAliasList;
    }

    public void setArtistAliasList(List<ArtistAliasList_> artistAliasList) {
    ...
    public ArtistCredits_ getArtistCredits() {
        return artistCredits;
    }

    public void setArtistCredits(ArtistCredits_ artistCredits) {
